...
export default function About() {
    ...
    return (
        <section id="about" className="max-w-7xl mx-auto px-6 md:px-12 py-32 md:py-48" data-testid="section-about">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-10 md:gap-16">
                <Reveal className="md:col-span-7">
                    ...
                    <p className="mt-10 text-zinc-400 leading-relaxed max-w-xl text-base md:text-lg">
                        {profile.aboutInfo}
                    </p>
                </Reveal>

                <div className="md:col-span-5 md:pt-8 space-y-8">
                    {
                        manifesto.map((m, i) => (
